...
/**
 * O "G" da Google é a única exceção à paleta de uma cor só: a marca só é
 * reconhecível nas quatro cores oficiais, então ela não segue `tema`.
 */
export function LogoGoogle({ tamanho = 18 }: { tamanho?: number }) {
  return (
    <Svg width={tamanho} height={tamanho} viewBox="0 0 18 18">
      ...
      <Path
        fill="#34A853"
        d="M9 18c2.43 0 4.4673-.806 5.9564-2.1805l-2.9087-2.2581c-.8059.54-1.8368.8578-3.0477.8578-2.3436 0-4.3282-1.5831-5.036-3.7104H.9573v2.3318C2.4382 15.9832 5.4818 18 9 18z"
      />
      <Path
        fill="#FBBC05"
