...
import { animacao, cores, espaco, tamanhos, tipo } from '@/tema';
    ...
    <View>
      <View style={estilos.palco}>
        ...
        <View style={estilos.centro} pointerEvents="box-none">
          <Text style={[tipo.rotuloSecao, estilos.centroRotulo]}>{rotulo}</Text>
          <Text style={estilos.centroTitulo}>{titulo}</Text>
          <Text style={estilos.centroNota}>{nota}</Text>
          ...
          >
            <Text style={estilos.centroAcaoTexto}>{acao}</Text>
...
const estilos = StyleSheet.create({
  ...
  centroRotulo: { color: cores.acento, textTransform: 'uppercase' },
  centroTitulo: {
    ...tipo.tituloItem,
  ...
  centroAcaoTexto: { ...tipo.botaoDiscreto, color: cores.acento },
