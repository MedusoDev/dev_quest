...
import { cores, espaco, margemTela, siglaLinguagem, tamanhos, tipo } from '@/tema';
  ...
  return (
    <TelaAba>
      <View style={estilos.barra}>
        ...
        >
          <Text style={estilos.glossarioTexto}>glossário</Text>
        </Pressable>
      </View>
          ...
          {secoes.map((secao) => (
            <Fragment key={secao.chave}>
              <View style={estilos.secao}>
                ...
                <Text style={estilos.secaoContagem}>
                ...
                return (
                  ...
                  >
                    <View
                      style={[
                        estilos.no,
                        concluida && estilos.noFeito,
                        ehAtual && estilos.noAtual,
                        !concluida && !ehAtual && estilos.noVazio
                      ]}
                    >
                      {concluida ? (
                        <Text style={estilos.noFeitoTexto}>✓</Text>
                      ) : ehAtual ? (
                        <Text style={estilos.noAtualTexto}>{fila.indexOf(licao) + 1}</Text>
                      ) : null}
                    </View>
...
const estilos = StyleSheet.create({
  ...
  glossarioTexto: { ...tipo.metricaMono, color: cores.legenda },
  ...
  secaoContagem: { ...tipo.metricaMono, color: cores.legenda },
  ...
  noFeito: { backgroundColor: cores.acento },
  noFeitoTexto: { fontFamily: tipo.metricaPequena.fontFamily, fontSize: 11, color: cores.acentoFundo },
  noAtual: { borderWidth: 2, borderColor: cores.acento },
  noAtualTexto: { fontFamily: tipo.metricaPequena.fontFamily, fontSize: 10, color: cores.acento },
  noVazio: { borderWidth: tamanhos.linha, borderColor: cores.linha },
